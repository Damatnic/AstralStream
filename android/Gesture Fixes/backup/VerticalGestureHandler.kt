...
class VerticalGestureHandler(
    ...
    suspend fun PointerInputScope.detectVerticalGestures(
        ...
        awaitEachGesture {
            ...
            startGesture(firstDown, volumeSettings, brightnessSettings)
            ...
            do {
                ...
                if (isActive) {
                    updateGesture(currentPointer, volumeSettings, brightnessSettings)
    ...
    private fun startGesture(
        ...
        touchSide = determineTouchSide(firstDown.position, size.width.toFloat())
        accumulatedDelta = 0f
    ...
    private fun updateGesture(
        ...
        when (gestureType) {
            GestureType.VERTICAL_VOLUME -> {
                val volumeDelta = adjustedDelta / size.height * volumeSettings.volumeStep
            ...
            GestureType.VERTICAL_BRIGHTNESS -> {
                val brightnessDelta = adjustedDelta / size.height * brightnessSettings.brightnessStep
